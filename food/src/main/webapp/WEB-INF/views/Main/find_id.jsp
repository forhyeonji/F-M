...
<link rel="stylesheet" href="../../../resources/CSS/Main_CSS/find_id.css">
<script src="http://code.jquery.com/jquery-latest.js"></script> 

<div class="findId_outborder">

	<div id="findId_homelogo">
		<a class="findId_a" href="/"><img class="findId_img" src="../../../resources/image/HeaderImg/푸렌드2.png"></a>	
	</div>
	<br><br><br><br>
	...
	<div class="findId_wrap">
		...
		<div>
			<h3 class="findId_sub2">아이디 찾기</h3>
		</div>
