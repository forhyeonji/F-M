				...
				<div id="btfTab" class="tab">
					...
					<ul class="tab-contents">
						...
						<li id="product-etc">
							...
							<ul class="prod-list">
								<li>ㆍ상품 포장을 개봉하여 상품의 가치가 훼손된 경우 (단,이중포장의 경우 속 포장지까지 제거한 경우만
									해당)</li>
							...
							<table class="prod-table">
								...
								<tbody>
									<tr>
										...
										<td>
											<p>ㆍ받으신 상품이 표시·광고 내용 또는 계약 내용과 다른 경우에는 상품을 받은 날부터 3개월 이내,</p>
											<span>※ 상품에 문제가 있는 것으로 확인되면 배송비는 "푸렌드"가 부담합니다.</span>
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											</p> <span id="sh_cssprod">※ 단순 변심으로 인한 교환 또는 환불의 경우 고객님께서
												배송비 6,000원을 부담하셔야 합니다.</span>
										</td>
									</tr>
									<tr>
										...
										<td>
											<p>다음에 해당하는 교환·환불 신청은 처리가 어려울 수 있으니 양해 부탁드립니다.</p> <span>고객님의
												...
												곤란할 정도로 상품의 가치가 감소한 경우</span><br> <span>복제가 가능한 상품의 포장이
												훼손된 경우</span>
										</td>
									</tr>
