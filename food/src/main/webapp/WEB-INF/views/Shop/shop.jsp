		...
		<div class="shopall">
			<ul class="header">
				<li><a href="#">Category</a>
					<ul class="submenu">
						<li><a href="http://localhost:8950/shopconer">meat</a></li>
			...
			<div class="main">
				<div class="division_1">
					<a href="#"><h2>인기 상품></h2></a>
				</div>
				<div class="main_top">
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/배추.jpg">
						</div>
						<div class="text">
					...
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/복숭아.jpg">
						</div>
					...
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/고등어.jpg">
						</div>
						<div class="parcel">한진택배</div>
					...
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/안심.jpg">
						</div>
						<div class="parcel">한진택배</div>
				...
				<div class="division_2">
					<a href="#"><h2>F&M이 추천하는 신상 제품></h2></a>
				</div>

				<div class="main_middle">
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/규동.jpg">
						</div>
						<div class="parcel">한진택배</div>
						<div class="guydong">
							규동<br> 소고기 덮밥용
					...
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/granate.jpg">
						</div>
						<div class="parcel">한진택배</div>
					...
					<div class="main_image_1">
						<div class="img">
							<img src="../../../resources/image/VINIQ.jpg">
						</div>
						<div class="parcel">한진택배</div>
