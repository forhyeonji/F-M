...
<div id="container">
	...
	<div id="main">
		...
		<div id="main_center">
		<label id="notice_lable">자주하는 질문</label>  <label>어쩌고 저쩌고~</label> <br><br>
		
		<input type="button" class="but" value="글쓰기" onclick="location.href='http://localhost:8080/QnA_write'">
		<hr>
		<table>
		<tr id="bar">
		...
		<tr>
			<td colspan="4" class="title_effect"><a href="http://localhost:8080/QnA_detail">자세히 보려면 여기 클릭하세요</a></td>
		</tr>
